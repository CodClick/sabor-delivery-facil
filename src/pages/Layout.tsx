          ...
          <CardContent className="space-y-4">
            ...
            <div className="border-t pt-4 space-y-3">
              ...
              <div className="flex gap-2">
                <Button
                  type="button"
                  variant={coverBackgroundTipo === 'cor' ? 'default' : 'outline'}
                  size="sm"
                  onClick={() => setCoverBackgroundTipo('cor')}
                >
                  Cor
                </Button>
                <Button
                  type="button"
                  variant={coverBackgroundTipo === 'imagem' ? 'default' : 'outline'}
                  size="sm"
                  onClick={() => setCoverBackgroundTipo('imagem')}
                >
                  Imagem
                </Button>
              </div>

              {coverBackgroundTipo === 'cor' ? (
                <div className="flex items-center gap-2">
                  <Input
                    type="color"
                    value={corBackgroundCover}
                    onChange={(e) => setCorBackgroundCover(e.target.value)}
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <Input
                      value={coverBackgroundImagemUrl}
                      onChange={(e) => setCoverBackgroundImagemUrl(e.target.value)}
                    ...
                    <label className="cursor-pointer">
                      <input
                        ...
                        accept="image/*"
                        className="hidden"
                        onChange={(e) => handleImageUpload(e, setCoverBackgroundImagemUrl)}
                      />
                      <Button type="button" variant="outline" size="icon" asChild disabled={isUploading}>
                        <span><Upload className="h-4 w-4" /></span>
                      </Button>
                  ...
                  {coverBackgroundImagemUrl && (
                    <div className="w-full max-w-[300px] aspect-[3/2] mt-2 rounded-lg overflow-hidden border">
                      <img src={coverBackgroundImagemUrl} alt="Fundo da capa" className="w-full h-full object-cover" />
                    </div>
                  )}
                </div>
              )}

  ...
  return (
    <div className="relative">
      <div className="h-48 sm:h-64 w-full bg-gradient-to-l from-brand-300 to-brand-600 overflow-hidden">
        <img
          src="https://ypsfoumafbfgcvrxylmw.supabase.co/storage/v1/object/public/imagens_cardapio/skqilw7p1u8_1759169606801.webp"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex flex-col sm:flex-row items-center">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-gray-600 mt-1"><b>Rua Nina Zanoto,646-Jd. Las Vegas-Sto André</b></p>
